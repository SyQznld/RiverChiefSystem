package com.appler.riverchiefsystem.utils.customView.pickerView;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(com.bigkoo.pickerview.R.color.pickerview_wheelview_textcolor_out);
        textColorCenter = getResources().getColor(com.bigkoo.pickerview.R.color.pickerview_wheelview_textcolor_center);
        dividerColor = getResources().getColor(com.bigkoo.pickerview.R.color.pickerview_wheelview_textcolor_divider);
        ...
        customTextSize = getResources().getBoolean(com.bigkoo.pickerview.R.bool.pickerview_customTextSize);
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.bigkoo.pickerview.R.styleable.wheelview, 0, 0);
            mGravity = a.getInt(com.bigkoo.pickerview.R.styleable.wheelview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(com.bigkoo.pickerview.R.styleable.wheelview_textColorOut, textColorOut);
            textColorCenter = a.getColor(com.bigkoo.pickerview.R.styleable.wheelview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(com.bigkoo.pickerview.R.styleable.wheelview_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(com.bigkoo.pickerview.R.styleable.wheelview_textSize, textSize);
        }
    ...
    void smoothScroll(com.bigkoo.pickerview.lib.WheelView.ACTION action) {
        cancelFuture();
        if (action == com.bigkoo.pickerview.lib.WheelView.ACTION.FLING || action == com.bigkoo.pickerview.lib.WheelView.ACTION.DAGGLE) {
            ...
            default:
                if (!eventConsumed) {
                    ...
                    if ((System.currentTimeMillis() - startTime) > 120) {
                        // 处理拖拽事件
                        smoothScroll(com.bigkoo.pickerview.lib.WheelView.ACTION.DAGGLE);
                    } else {
                        // 处理条目点击事件
                        smoothScroll(com.bigkoo.pickerview.lib.WheelView.ACTION.CLICK);
                    }
                }
                break;
        }
