...
public class ZipUtil {
    ...
    public static void zipFolder(Context context, String srcFilePath, String zipFilePath, zipFinish finish) throws Exception {
        ...
        outZip.close();
        finish.zipFinish();
        Toast.makeText(context, "压缩包完成", Toast.LENGTH_SHORT).show();
    }
